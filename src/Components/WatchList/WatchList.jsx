...
function WatchList() {
  ...
  const allTypes = ["movie", "tv show", "video song","short film","web series","documentary","trailer"];
  return (
    ...
    >
      ...
      <IoIosArrowDown className={`down-arrow-icon ${isArrowRotated ? 'rotate-arrow' : ''}`} />
          ...
          <div
            className={`recent-btn-content${
              isArrowRotated ? "recent-btn-content" : ""
            }`}
          >
            <p
              class="recent-btn-option"
              onClick={() => optionHandler("Most Recent Addition")}
            >
              Most Recent Addition
            </p>
            <p
              class="recent-btn-option"
              onClick={() => optionHandler("Title: A-Z")}
            >
              Title: A-Z
            </p>
            <p
              class="recent-btn-option last-option"
              onClick={() => optionHandler("Title: Z-A")}
            >
              Title: Z-A
            </p>
          </div>
